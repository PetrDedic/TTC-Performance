...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("moto-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("moto-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      <StyledRealizace>
        ...
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/moto">Motorky</Link>
          {" > "}
          {brand.name}
        </div>
                          ...
                          <Flex direction="column" gap={8}>
                            ...
                            {model.engines
                              ...
                              .map((engine) => (
                                ...
                                >
                                  <Link
                                    href={`/vozidla/moto/${encodeURIComponent(
                                      brand.name
