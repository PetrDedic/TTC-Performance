...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("squad-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("squad-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      <StyledRealizace>
        ...
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/ctyrkolky">Čtyřkolky</Link>
          {" > "}
          {brand.name}
        </div>
