...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("car-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("car-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      >
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/osobni">Osobní vozidla</Link>
          {" > "}
          {brand.name}
        </div>
                        ...
                        <Flex direction="column" gap={8}>
                          ...
                          {model.engines
                            ...
                            .map((engine) => (
                              ...
                              >
                                <Link
                                  href={`/vozidla/osobni/${encodeURIComponent(
                                    brand.name
