...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("truck-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("truck-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      >
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/nakladni">Nákladní vozidla</Link>
          {" > "}
          {brand.name}
        </div>
                        ...
                        <Flex direction="column" gap={8}>
                          ...
                          {model.engines
                            ...
                            .map((engine) => (
                              ...
                              >
                                <Link
                                  href={`/vozidla/nakladni/${encodeURIComponent(
                                    brand.name
