...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("boat-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("boat-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      >
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/lode">Lodě</Link>
          {" > "}
          {brand.name}
        </div>
                        ...
                        <Flex direction="column" gap={8}>
                          ...
                          {model.engines
                            ...
                            .map((engine) => (
                              ...
                              >
                                <Link
                                  href={`/vozidla/lode/${encodeURIComponent(
                                    brand.name
