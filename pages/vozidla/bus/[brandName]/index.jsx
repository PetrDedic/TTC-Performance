...
const Vozidla = ({ brand, models }) => {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem("bus-accordionState");
    if (savedState) {
  ...
  const handleAccordionChange = (value) => {
    ...
    localStorage.setItem("bus-accordionState", JSON.stringify(value));
  };
    ...
    <>
      ...
      >
        <div className="nav">
          ...
          {" > "}
          <Link href="/vozidla/bus">Autobusy</Link>
          {" > "}
          {brand.name}
        </div>
                        ...
                        <Flex direction="column" gap={8}>
                          ...
                          {model.engines
                            ...
                            .map((engine) => (
                              ...
                              >
                                <Link
                                  href={`/vozidla/bus/${encodeURIComponent(
                                    brand.name
